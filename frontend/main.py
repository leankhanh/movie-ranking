...
API_KEY = "25d6ad9dbc3b86641cb8202ebe23f82b"
...
def edit():
    ...
    if form.validate_on_submit():
        # UPDATE RECORD
        movie_selected.rating = request.form["your_rating"]
        movie_selected.review = request.form["your_review"]
        db.session.commit()
...
def add():
    ...
    if form.validate_on_submit():
        ...
        response = requests.get(url=f'https://api.themoviedb.org/3/search/movie?api_key={API_KEY}&query={movie_title}')
        data = response.json()
